                            ...
                            <div class="grid__item--1of1 text-center">
                                <div class="tabs">
                                    ...
                                    <label for="tab1" class="labelTab">
                                        <i class="icon snapshot"></i><span>Dados Pessoais</span>
                                    </label>
                                    <input type="radio" name="tabs" id="tab2">
                                    <label for="tab2" class="labelTab">
                                        <i class="icon email-cal"></i><span>Endereço</span>
                                    </label>
                                    ...
                                    <div id="tab__content--1" class="tab__content">
                                        @include('admin.usuarios.tabs.dados_pessoais')
                                    </div>
                                    <div id="tab__content--2" class="tab__content">
                                        @include('admin.usuarios.tabs.endereco')
                                    </div>
                                    <div id="tab__content--3" class="tab__content">
                                        @include('admin.usuarios.tabs.documentos')
                                    </div>
                                    <div id="tab__content--4" class="tab__content">
                                        @include('admin.usuarios.tabs.informacoes_hierarquia')
                                    </div>
                                </div>
                            </div>
                        </article>
