...
@section('title', 'Marcações Ponto')

@section('content_header')
    <h1>Marcações Ponto</h1>
@stop
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            <a type="button" href="{{ route('ponto.cadastrar') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nova Marcação</a>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <span>Marcações Realizadas</span>
                </div>
                <div class="card-body">
                                ...
                                @if(!empty($pontos))
                                    @foreach($pontos as $ponto)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $ponto->ip ?? '-' }}</td>
                                            <td><a type="button" href="{{ route('ponto.detalhes', ['id' => $ponto->id]) }}">Detalhes</a></td>
                                        </tr>
                                    @endforeach
                                @else
                                    <tr>
...
@section('js')
    ...
    <script src="{{ asset('js/guest/ponto/index.js') }}" type="text/javascript"></script>
@stop
